    ...
    const handleSend = async () => {
        ...
        dispatch({
            ...
            payload: {
                ...
                message: { id: `msg_${Date.now()}`, sender: "user", text: userMessage },
            },
        });
        ...
        dispatch({
            ...
            payload: {
                sessionId: currentSessionId,
                message: { id: `msg_typing_${Date.now()}`, sender: "ai", text: "Typing..." },
            },
        });
    ...
    return (
        <div className="px-6 py-4 bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-700">
            <div className="relative">
                ...
                <button
                    onClick={handleSend}
                    disabled={isLoading || !input.trim() || !state.activeSessionId}
